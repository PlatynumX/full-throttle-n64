...
if [ "$rc" -eq 0 ] && [ -f "$PORT/full-throttle-n64-r2m.z64" ]; then
  cp "$PORT/full-throttle-n64-r2m.z64" "$ART/full-throttle-n64-r2m.z64"
  sha256sum "$ART/full-throttle-n64-r2m.z64" > "$ART/full-throttle-n64-r2m.sha256"
