...
if [ "$rc" -eq 0 ] && [ -f "$PORT/full-throttle-n64-r2j.z64" ]; then
  cp "$PORT/full-throttle-n64-r2j.z64" "$ART/full-throttle-n64-r2j.z64"
  sha256sum "$ART/full-throttle-n64-r2j.z64" > "$ART/full-throttle-n64-r2j.sha256"
