...
if [ "$rc" -eq 0 ] && [ -f "$PORT/full-throttle-n64-r2p.z64" ]; then
  cp "$PORT/full-throttle-n64-r2p.z64" "$ART/full-throttle-n64-r2p.z64"
  sha256sum "$ART/full-throttle-n64-r2p.z64" > "$ART/full-throttle-n64-r2p.sha256"
