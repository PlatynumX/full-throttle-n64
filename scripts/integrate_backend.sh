...
grep -Fq 'FT64 r2v structural: sound 633 transition recovery' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '"sound-633-stop"' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq 'type == rtSound && idx == 633' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq 'size >= 512 * 1024' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '_vm->_sound->stopAllSounds();' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq 'FT64 r2v structural: large sound allocation recovery' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '"large-sound-purge"' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '"large-sound-evict"' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '"large-sound-retry"' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '"large-sound-retry-ok"' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq 'ft64SoundId-- > 0' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq '!_vm->isResourceInUse(rtSound, ft64SoundId)' "$SCUMMVM/engines/scumm/resource.cpp"
grep -Fq 'nukeResource(rtSound, ft64SoundId);' "$SCUMMVM/engines/scumm/resource.cpp"
