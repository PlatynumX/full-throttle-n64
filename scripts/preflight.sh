...
grep -Fq 'sound 633 transition recovery' "$SPECIALIZER"
grep -Fq '"sound-633-stop"' "$SPECIALIZER"
grep -Fq 'idx == 633' "$SPECIALIZER"
grep -Fq 'size >= 512 * 1024' "$SPECIALIZER"
grep -Fq '_vm->_sound->stopAllSounds();' "$SPECIALIZER"
grep -Fq 'large sound allocation recovery' "$SPECIALIZER"
grep -Fq '"large-sound-purge"' "$SPECIALIZER"
grep -Fq '"large-sound-evict"' "$SPECIALIZER"
grep -Fq '"large-sound-retry"' "$SPECIALIZER"
grep -Fq '"large-sound-retry-ok"' "$SPECIALIZER"
grep -Fq 'ft64SoundId-- > 0' "$SPECIALIZER"
grep -Fq '!_vm->isResourceInUse(rtSound, ft64SoundId)' "$SPECIALIZER"
grep -Fq 'nukeResource(rtSound, ft64SoundId);' "$SPECIALIZER"
